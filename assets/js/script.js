...
function getApi() {
  ...
  fetch(requestUrl)
    ...
    .then(function generatePokemons(data) {
      ...
      let imgValue = document
        .querySelector(".pokeImg")
        .setAttribute(
          "src",
  ...
  fetch(requestUrl2)
    ...
    .then(function generatePokemons(data) {
      ...
      let imgValue2 = document
        .querySelector(".pokeImg2")
        .setAttribute(
          "src",
          data.sprites.other["official-artwork"].front_default
        );
  ...
  fetch(requestUrl3)
    ...
    .then(function generatePokemons(data) {
      ...
      let imgValue3 = document
        .querySelector(".pokeImg3")
        .setAttribute(
          "src",
          data.sprites.other["official-artwork"].front_default
        );
  ...
  fetch(requestUrl4)
    ...
    .then(function generatePokemons(data) {
      ...
      let imgValue4 = document
        .querySelector(".pokeImg4")
        .setAttribute(
          "src",
          data.sprites.other["official-artwork"].front_default
        );
  ...
  fetch(requestUrl5)
    ...
    .then(function generatePokemons(data) {
      ...
      let imgValue5 = document
        .querySelector(".pokeImg5")
        .setAttribute(
          "src",
          data.sprites.other["official-artwork"].front_default
        );
  ...
  fetch(requestUrl6)
    ...
    .then(function generatePokemons(data) {
      ...
      let imgValue6 = document
        .querySelector(".pokeImg6")
        .setAttribute(
          "src",
          data.sprites.other["official-artwork"].front_default
        );
